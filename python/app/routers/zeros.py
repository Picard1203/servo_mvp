...
def list_zeros(zeros: ZeroDep) -> list[ZeroResponse]:
    ...
    Returns:
        list[ZeroResponse]: Stored zero references list.
    """
    result: list[ZeroResponse] = []
...
def capture_zero(request: ZeroCaptureRequest,
    ...
    Args:
        request (ZeroCaptureRequest): The zero name request.
        zeros (ZeroService): Injected zero service.

    Returns:
        ZeroResponse: The stored zero reference.
    """
...
def activate_zero(zero_id: int, zeros: ZeroDep) -> ZeroActionResponse:
    ...
    Returns:
        ZeroActionResponse: Acknowledgement of activation action.
    """
...
def delete_zero(zero_id: int, zeros: ZeroDep) -> ZeroActionResponse:
    ...
    Returns:
        ZeroActionResponse: Acknowledgement of deletion action.
    """
