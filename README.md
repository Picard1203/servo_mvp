...
**Status:** backend, UI, sketch and tests all exist and pass (211 Python tests,
194 native checks, bridge contract agrees). The system is stable —
see `docs/BACKLOG.md` for remaining tasks.
